...
const buildPrompt = ({ word, tone, variations, includeTranslation })=>{
    ...
    return [
        ...
        `Return JSON only as an array of objects with fields: sentence, tone, translation${includeTranslation ? "" : " (translation can be null)"}.`,
