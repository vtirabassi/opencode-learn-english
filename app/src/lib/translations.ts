...
export const translations = {
  "en-US": {
    ...
    settingsLocalData: "Your data is stored in your authenticated cloud account.",
    ...
    notesDeleteNote: "Delete",
    notesDeleteConfirm: "Are you sure you want to delete this note?",
    notesSaveButton: "Save",
    notesSaving: "Saving...",
    notesUnsavedChanges: "Unsaved changes",
    notesEmptyList: "No notes yet. Create your first note!",
    notesBackToList: "Back to notes",
    notesSelectNote: "Select a note to start editing",
    notesUnsavedWarning: "You have unsaved changes. Discard them?",
  ...
  "pt-BR": {
    ...
    settingsLocalData: "Seus dados ficam na nuvem da sua conta autenticada.",
    ...
    notesDeleteNote: "Excluir",
    notesDeleteConfirm: "Tem certeza que deseja excluir esta nota?",
    notesSaveButton: "Salvar",
    notesSaving: "Salvando...",
    notesUnsavedChanges: "Alterações não salvas",
    notesEmptyList: "Nenhuma nota ainda. Crie sua primeira nota!",
    notesBackToList: "Voltar às notas",
    notesSelectNote: "Selecione uma nota para editar",
    notesUnsavedWarning: "Você tem alterações não salvas. Descartar?",
